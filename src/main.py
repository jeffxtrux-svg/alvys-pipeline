...
def main() -> int:
    ...
    start_date = os.environ.get("ALVYS_START_DATE", "2024-01-01")
    ...
    # --- Fetch invoices and build LoadNumber-keyed invoice indexes ---
    log.info("=" * 60)
    ...
    # If columns come back blank, these files show the actual API field
    # names so we can fix the mappings.
    import json
