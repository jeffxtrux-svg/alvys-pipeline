...
Reads JB's MTD-landing forecasts from
...
The grades feed JB's track record over time. After enough monthly
forecasts, the brief can show his Brier-style accuracy and flag
...
def render_summary_html(results: list[dict],
    ...
    return (
        ...
        f"Forecast Accuracy &middot; JB MTD Calls</div>"
        f"<div>{chips}</div>"
