...
3. **Schedule for inspection** — units past the 120d company policy are **flagged as needing inspection**; they remain in service while scheduling. Aim to inspect within the 14-day window so no unit drifts toward the federal 365d limit. Only at 245+ days past the 120d policy would a unit hit the federal limit — that boundary is the one that would actually warrant pulling from service. Trailers can typically finish their current load before scheduled inspection; document any judgment call.
