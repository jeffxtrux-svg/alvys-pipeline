...
- **2026-06 — Triumph engagement initiated (status: in-flight).** Selected Triumph over Pathward / OTR / eCapital. Onboarding required clearing the existing operating loan via a $40K owner capital injection (Jeff + JB, $20K each) plus a trailer refinance. Capture full outcome and 90-day post-mortem once the switch completes. See [[Factoring]], [[Decision Journal]].
