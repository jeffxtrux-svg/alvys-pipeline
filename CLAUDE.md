...
|----------|------|------------|
| `refresh.yml` | Alvys pull → OneDrive → artifact | `0 9,16,22 * * *` |
...
| `scorecard_email.yml` | read OneDrive → email daily brief (13 pages) | 5am-CT-year-round: `0,15,30 10` + `0,30 11` + `0 12` UTC, gated to skip pre-5am-CT slots |
...
Crons are fixed UTC and were pulled **2 hours earlier in June 2026**. The three pulls (Alvys / Samsara / QB) fire concurrently at **3:00am CST** (4:00am CDT) / 10am / 4pm Central; SambaSafety lands **at 1:30am CST** (2:30am CDT) so its workbook is in OneDrive ahead of the scorecard; the scorecard email primary follows at **5:00am Central year-round** — the workflow arms cron slots for both CDT (10 UTC) and CST (11 UTC) and gates the wrong-season slot with a Central-time hour check at the top of the job, so the brief lands at 5am CT whether DST is in effect or not; the Google Sheets KPI dashboard refresh runs at **3:30am CST** (4:30am CDT).
